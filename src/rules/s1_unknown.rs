...
pub struct RuleUnknown {}

impl Rule for RuleUnknown {
    fn uid() -> String {
        return "s1".to_string();
    }
    ...
    fn trigger(&self) -> Trigger {
        let judger = |v: &Value| {
            ...
            match v.as_str() {
                Some(s) if s == AddupStatement::Unknown.to_string() => true,
                _ => return false,
            }
        };
    ...
    fn info(&self) -> RuleInfo {
        ...
        let description: String = "Unsupported to detect the statement".to_string();
